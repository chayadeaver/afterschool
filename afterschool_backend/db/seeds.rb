...
Schedule.create(weekday: "Tuesday", subject: "Reading", content: "Completed chapter 1 of Lost", child_id: 1)
Schedule.create(weekday: "Wednesday", subject: "Creative Writing", content: "Wrote a story about my Favorite things to eat", child_id: 1)
Schedule.create(weekday: "Thursday", subject: "Physical Education", content: "Did 15 Jumping Jacks and 15 Sit Ups", child_id: 1)
Schedule.create(weekday: "Friday", subject: "Music", content: "Listened to Beethoven on You Tube", child_id: 1)
Schedule.create(weekday: "Monday", subject: "Math", content: "Completed chapter 2 of Go Math", child_id: 1)
Schedule.create(weekday: "Tuesday", subject: "Reading", content: "Completed chapter 2 of Lost", child_id: 1)
Schedule.create(weekday: "Wednesday", subject: "Creative Writing", content: "Wrote a story about my family", child_id: 1)
